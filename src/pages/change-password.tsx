...
export default function ChangePassword() {
    ...
    const onSubmit = async ({ oldPassword, newPassword, confirmPassword }: FormValues) => {
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6 w-72">
                            <div className="flex flex-col gap-2">
                                ...
                                />
                                {errors.oldPassword && <span className="error">Old password is required</span>}
                            </div>
                            <div className="flex flex-col gap-2">
                                ...
                                />
                                {errors.newPassword && <span className="error">New password is required</span>}
                            </div>
                            <div className="flex flex-col gap-2">
                            ...
                            <button className="justify-center mt-4 btn-primary">Change Password</button>
                        </form>
                    </>
                )}
            </main>
            {show && <NotificationSuccess toggleShow={toggleShow} text="Password changed successfully!" />}
        </div>
    );
}
